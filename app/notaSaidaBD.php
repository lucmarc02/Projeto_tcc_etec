...
$linhaTotalItem = $resultadoTotalItem->fetch(PDO::FETCH_ASSOC);
 ...
 //$vlEstoqueAtual = ($qtdSaida * $linhaTotalItem['vl_preco_med_prod']);
     ...
     echo("Saldo do material isuficiente para baixa! <a href= /tcc/saidaMaterial.php?id='$idMat'> Voltar<br><br> </a> ");
  ...
  (
    ...
    vl_total_item_saida,requisitante
     ...
     :vlTotalMaterial, :nmRequisitante)"
