...
/*
    if ($resultado->rowCount() > 0) {
      $bar        = $codBar;
      $descMat     = isset($linhaBar['descMatKard']) ? $linhaBar['descMatKard'] : " ";
      $loteMat     = isset($linhaBar['loteKard']) ? $linhaBar['loteKard'] : "";
      $medidaMat    = isset($linhaBar['medKard']) ? $linhaBar['medKard'] : "";
      $qtdEnt    = isset($linhaBar['qtdEntKard']) ? $linhaBar['qtdEntKard'] : "";
      $qtdSai   = isset($linhaBar['qtdSaiKard']) ? $linhaBar['qtdSaiKard'] : "";
      $precoMed   = isset($linhaBar['vlPreMedKard']) ? $linhaBar['vlPreMedKard'] : "";
